...
pub trait ReactionsApi {
    fn posts_ids_reactions_post(&self, request_body: Vec<String>) -> Box<dyn Future<Item = ::std::collections::HashMap<String, Vec<crate::models::Reaction>>, Error = Error<serde_json::Value>>>;
    fn posts_post_id_reactions_get(&self, post_id: &str) -> Box<dyn Future<Item = Vec<crate::models::Reaction>, Error = Error<serde_json::Value>>>;
    fn reactions_post(&self, reaction: crate::models::Reaction) -> Box<dyn Future<Item = crate::models::Reaction, Error = Error<serde_json::Value>>>;
    fn users_user_id_posts_post_id_reactions_emoji_name_delete(&self, user_id: &str, post_id: &str, emoji_name: &str) -> Box<dyn Future<Item = crate::models::StatusOk, Error = Error<serde_json::Value>>>;
}
