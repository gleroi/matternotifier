...
> Vec<String> logs_post(inline_object62)
Add log message
...
> crate::models::InlineResponse20010 redirect_location_get(url)
...
> crate::models::StatusOk site_url_test_post(inline_object59)
...
> trial_license_post(inline_object61)
